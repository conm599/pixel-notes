...
(function () {
  ...
  function ensureBar() {
    ...
    bar.innerHTML = '<span class="sel-count"></span>'
      ...
      + '<button type="button" class="sel-btn sel-paste" title="Ctrl+V"><i class="ic ic-paste"></i> 粘贴到当前文件夹</button>'
      + '<button type="button" class="sel-btn sel-all" title="Ctrl+A"><i class="ic ic-checkall"></i> 全选</button>'
      + '<button type="button" class="sel-btn sel-share"><i class="ic ic-link"></i>批量分享</button>'
      + '<button type="button" class="sel-btn sel-zip"><i class="ic ic-box"></i> 打包 ZIP</button>'
