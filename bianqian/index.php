...
<head>
    ...
    <link rel="stylesheet" href="css/pixel.css?v=110">
    <link rel="stylesheet" href="css/icons.css?v=7">
...
<body>
    ...
    <!-- 抽屉菜单（手机/PC 共用；PC 隐藏新建两项——新建走空白区域右键） -->
    ...
    <nav id="mobileMenu" class="mobile-menu" aria-hidden="true">
        ...
        <button type="button" id="mFolder" class="mm-item pc-hide"><i class="ic ic-folder"></i> 新建文件夹</button>
        ...
        <button type="button" id="mAiSettings" class="mm-item"><i class="ic ic-robot"></i> AI 设置</button>
    ...
    <!-- PC 右键菜单改为 JS 动态生成（空白/便签/文件夹三类上下文，见 app.js v115） -->
    ...
    <div class="main-container">
        ...
        <!-- 搜索弹层（v114：默认隐藏；PC 按 T 或 / 呼出，手机走抽屉「搜索」/搜索钮；Esc 关闭） -->
        ...
        <div id="newNoteForm" class="new-note-form" style="display:none;">
            ...
            <div class="form-group">
                <!-- AI 按钮站在工具栏最前面（buildToolbar 追加其余工具按钮在此之后）；纯文字更贴像素风 -->
                <div id="newToolbar" class="md-toolbar"><button type="button" id="btnAiEdit" class="md-btn btn-ai" title="AI 帮你编辑这篇便签">AI</button></div>
    ...
    <script src="js/tutorial-data.js?v=2"></script>

    <script src="js/Sortable.min.js"></script>
    <script src="js/ai-direct.js?v=25"></script>
    <script src="js/selection.js?v=7"></script>
    ...
    <script src="js/app.js?v=142"></script>
</body>
</html>